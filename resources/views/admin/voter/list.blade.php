              ...
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-title" id="basic-layout-form-center">Voter List</h4>
                    ...
                    <div class="card-block">
                      ...
                      @foreach ($voters as $voter)
                        <tr>
                          ...
                          <td>{{$voter->cnic}}</td>
                          <td>
                            <a href="{{url('/voter/'.$voter->id.'/edit')}}" class="btn btn-primary btn-sm">Edit</a>
                      ...
                      <div class="modal fade text-xs-left" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel4" aria-hidden="true">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <form action="{{url('/voter/'.$voter->id)}}" method="post">
                              @csrf
                              @method('DELETE')
